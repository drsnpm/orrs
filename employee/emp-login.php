        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-success">
              <div class="card-header"><img class="logo-img" src="assets/img/logo-xx.png" alt="logo" width="{conf.logoWidth}" height="27"><span class="splash-description">Please enter your information.</span></div>
              <div class="card-body">
            ...
            <div class="splash-footer">&copy; 2022 - <?php echo date ('Y');?> Online Railway Reservation System <br>Developed By Darshan PM</div>
          </div>
        </div>
      </div>
    </div>
