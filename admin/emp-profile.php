            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="user-display">
                  <div class="user-display-bg"><img src="assets/img/profile/<?php echo $row->admin_dpic;?>" alt="Profile Background" height="450"></div>
                    ...
                    <table class="no-border no-strip skills">
                      <tbody class="no-border-x no-border-y">
                        ...
                        <tr>
                          ...
                          <td class="item">User Name<span class="icon s7-map-marker"></span></td>
