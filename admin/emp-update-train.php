                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="current" value ="<?php echo $row->current;?>"  id="inputText3" type="text" requirwd>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="time" value = "<?php echo $row->time;?>" id="inputText3" type="datetime-local" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Number of passengers</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="passengers" value = "<?php echo $row->passengers;?>"  id="inputText3" type="text" pattern="[0-9]+" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Train Amount</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" name="fare" value = "<?php echo $row->fare;?>"  id="inputText3" type="text" pattern="[0-9]+" required>
                      </div>
                    </div>
