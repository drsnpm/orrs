...
{
      $id=intval($_GET['del']);
      $adn="delete from orrs_passwordresets where pwd_id=?";
                  ...
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    ?>
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center">
                            <a class ="badge badge-success" href ="emp-confirm-password_reset.php?pwd_id=<?php echo $row->pwd_id;?>">Approve</a> 
                            <a class ="badge badge-danger" href ="emp-pending-pwdresets.php?del=<?php echo $row->pwd_id;?>">Delete</a>
                        </td>    
